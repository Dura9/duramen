...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS score_porn INTEGER DEFAULT 0;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS score_masturb INTEGER DEFAULT 0;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS flag_conditioned_high BOOLEAN DEFAULT FALSE;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS flag_conditioned_moderate BOOLEAN DEFAULT FALSE;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS profile_type TEXT DEFAULT 'cognitive';
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS cost TEXT;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS desire TEXT;
